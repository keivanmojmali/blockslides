import type { NodeWithPos } from '@blockslides/core'
import { combineTransactionSteps, findChildrenInRange, getChangedRanges, getMarksBetween } from '@blockslides/core'
import type { MarkType } from '@blockslides/pm/model'
