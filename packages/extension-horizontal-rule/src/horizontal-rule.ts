import { canInsertNode, isNodeSelection, mergeAttributes, Node, nodeInputRule } from '@blockslides/core'
import { NodeSelection, TextSelection } from '@blockslides/pm/state'
