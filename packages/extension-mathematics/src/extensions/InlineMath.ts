import { InputRule, mergeAttributes, Node } from '@blockslides/core'
import type { Node as PMNode } from '@blockslides/pm/model'
 ...
 * @example
 * ```javascript
 * import { InlineMath } from '@blockslides/extension-mathematics'
