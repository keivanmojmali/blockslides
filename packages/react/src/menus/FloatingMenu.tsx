import type { FloatingMenuPluginProps } from '@autoartifacts/extension-floating-menu'
import { FloatingMenuPlugin } from '@autoartifacts/extension-floating-menu'
import { useCurrentEditor } from '@autoartifacts/react'
