...
import type { DOMOutputSpec, Node as ProseMirrorNode } from '@autoartifacts/pm/model'
...
import {
  ...
  toggleHeader,
  toggleHeaderCell,
} from '@autoartifacts/pm/tables'
import type { EditorView, NodeView } from '@autoartifacts/pm/view'
