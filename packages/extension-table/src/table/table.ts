...
import type { DOMOutputSpec, Node as ProseMirrorNode } from '@blockslides/pm/model'
...
import {
  ...
  toggleHeader,
  toggleHeaderCell,
} from '@blockslides/pm/tables'
import type { EditorView, NodeView } from '@blockslides/pm/view'
