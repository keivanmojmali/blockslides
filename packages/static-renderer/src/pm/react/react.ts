...
import type { DOMOutputSpecArray, Extensions, JSONContent } from '@blockslides/core'
import type { DOMOutputSpec, Mark, Node } from '@blockslides/pm/model'
...
export function domOutputSpecToReactElement(
  ...
  throw new Error(
    '[blockslides error]: Unsupported DomOutputSpec type, check the `renderHTML` method output or implement a node mapping',
    {
      cause: content,
    },
  )
