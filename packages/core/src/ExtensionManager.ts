import { keymap } from "@blockslides/pm/keymap";
import type { Schema } from "@blockslides/pm/model";
...
export class ExtensionManager {
  ...
  get plugins(): Plugin[] {
    ...
    const allPlugins = extensions.flatMap((extension) => {
      ...
      if (
        extension.type === "mark" &&
        getExtensionField<MarkConfig["exitable"]>(
          extension,
          "exitable",
          context
        )
      ...
      nodeExtensions
        ...
        .map((extension) => {
          ...
          const context = {
            ...
            options: extension.options,
            storage:
              this.editor.extensionStorage[extension.name as keyof Storage],
            editor,
